...
leadForm?.addEventListener("submit", async (event) => {
  ...
  const errors = {
    name: leadValidators.name(nameValue),
    phone: leadValidators.phone(phoneValue, contactValue),
    contactHandle: leadValidators.contactHandle(contactValue, phoneValue)
  };
